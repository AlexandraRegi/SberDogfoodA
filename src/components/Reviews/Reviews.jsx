...
export const Reviews = ({ onSendReview, reviews, onDeleteReview }) => {
    ...
    return (<>
        <div className={s.reviews}>
            ...
            <button className="btn btn_type_primary" onClick={() => setShowForm(true)}>Оставить отзыв</button>
            </div>
            {showForm &&
            ...
            <div className={s.reviews__list}>
                ...
                {reviews.sort((a, b) => new Date(b.updated_at) - new Date(a.updated_at)).map((e) =>
                        <div key={e._id}>
